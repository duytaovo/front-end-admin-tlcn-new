...
import { addMainboard, getMainboard } from "src/store/accessory/mainboard";
...
const NewComputerPower: React.FC = () => {
  ...
  const onSubmit = handleSubmit(async (data) => {
    ...
    try {
      ...
      setIsSubmitting(true);
      const res = await dispatch(addMainboard(body));
      unwrapResult(res);
      ...
      >
        ...
        >
          <Input
            ...
            type="text"
            className=""
            errorMessage={errors.expansionSlot?.message}
          />
        </Form.Item>
