...
export const schemaProductSmartPhone = yup.object({
  ...
  launchTime: yup.string().required("Trường này là bắt buộc"),
  accessories: yup.string().required("Trường này là bắt buộc"),
  productStatus: yup.number().required("Trường này là bắt buộc"),
  ram: yup.string().required("Trường này là bắt buộc"),
  storageCapacity: yup.string().required("Trường này là bắt buộc"),
  color: yup.string().required("Trường này là bắt buộc"),
  price: yup.string().required("Trường này là bắt buộc"),
  salePrice: yup.string().required("Trường này là bắt buộc"),
